...
def options_and_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="Human-Being thinks for you about the meanings.",
        epilog="Example:  human-being input_text.txt > output_text.txt"
...
def run():
    """
    $ text | human-being                        # Accepts text from the pipe
    $ echo "...<text>..." | human-being         #

    $ human-being multilogue.txt new_turn.txt    # ...or files.
    """
    ...
    try:
        ...
        syslog.syslog(syslog.LOG_INFO, f"human-being: {utterance}.")
        syslog.closelog()
